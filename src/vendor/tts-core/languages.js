 ...
 * conventions.
 */
export const SUPERTONIC_V3_LANGUAGE_OPTIONS = [
...
export const AZURE_FALLBACK_LANGUAGE_OPTIONS = [
    { code: 'zh-CN', label: 'Chinese (Simplified)' },
    { code: 'zh-TW', label: 'Chinese (Traditional)' },
    { code: 'th-TH', label: 'Thai' },
];
export const TTS_LANGUAGE_OVERRIDE_OPTIONS = [
...
export function toShortLanguageCode(lang) {
    return lang.split('-')[0] ?? lang;
}
export function isSupertonicV3Language(lang) {

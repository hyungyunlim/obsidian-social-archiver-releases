...
export class WebtoonEpisodeSelectModal extends Modal {
  ...
  private renderEpisodeList(): void {
    ...
    pageEpisodes.forEach(episode => {
      ...
      if (isPaid) {
        const lockSvg = activeDocument.createElementNS('http://www.w3.org/2000/svg', 'svg');
        ...
        const lockPath = activeDocument.createElementNS('http://www.w3.org/2000/svg', 'path');
        ...
        const checkSvg = activeDocument.createElementNS('http://www.w3.org/2000/svg', 'svg');

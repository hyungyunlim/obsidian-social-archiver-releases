...
/**
 * Provider/source recorded on an AI comment.
 *
 * Local comments are generated by desktop CLI tools. Cloud comments are
 * generated by Workers AI and carry the concrete model in `model`.
 */
export type AICommentProviderId = AICli | 'apple' | 'workers-ai';
// `apple` = Apple's on-device model, generated by the desktop app's executor and
// synced in; the plugin itself never runs it (see AICli for local CLIs).

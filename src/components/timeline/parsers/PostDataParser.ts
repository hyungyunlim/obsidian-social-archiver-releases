    ...
    try {
      ...
      const postData: PostData = {
        ...
        metadata: {
          ...
          locationSource: frontmatter['locationSource'],
          locationExternalId: frontmatter['locationExternalId'],
          locationAddress: frontmatter['locationAddress'],
          locationUrl: frontmatter['locationUrl'],
          locationCategory: frontmatter['locationCategory'],
          locationPlaceKind: frontmatter['locationPlaceKind'],

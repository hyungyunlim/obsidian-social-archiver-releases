 ...
 */
export function toErrorResponse(command: string, version: string, e: unknown): CliResponse<never> {
...
export const statusHandler: Handler = async (_params, { host, version }) => {
...
export const archiveHandler: Handler = async (params, { host, version }) => {
  ...
  const includeFormattedTranscript =
    params['formattedTranscript'] !== undefined ? parseBool(params, 'formattedTranscript', false) : undefined;
...
export const subscribeHandler: Handler = async (params, { host, version }) => {
  const url = parseString(params, 'url', { required: true });
...
function parseNoteTarget(params: CliParams): { path?: string; active: boolean } {
...
export const postHandler: Handler = async (params, { host, version }) => {
  const result = await host.postNote(parseNoteTarget(params));
  return ok(COMMANDS.POST, version, result);
};

export const shareHandler: Handler = async (params, { host, version }) => {
...
export const jobsHandler: Handler = async (params, { host, version }) => {
...
export const jobsCheckHandler: Handler = async (params, { host, version }) => {
...
export const tagsHandler: Handler = async (params, { host, version }) => {
...
export const tagCreateHandler: Handler = async (params, { host, version }) => {
...
export const authorNotesHandler: Handler = async (params, { host, version }) => {
...
export const searchHandler: Handler = async (params, { host, version }) => {
...
export const bookmarkHandler: Handler = async (params, { host, version }) => {

...
// P1 flags
// -----------------------------------------------------------------------------
export const PROFILE_CRAWL_FLAGS = {
...
export const IMPORT_INSTAGRAM_FLAGS = {
...
export const AUTHOR_NOTES_FLAGS = {
...
export const AI_COMMENTS_FLAGS = {
    path: { description: 'Workspace note path.', value: '<workspace-path>', required: true },
    ...FORMAT_FLAG,
};
export const AI_PROVIDERS_FLAGS = {
    ...FORMAT_FLAG,
};
...
export const SUBSCRIPTIONS_FLAGS = {
    action: {
...
export const FLAGS_BY_COMMAND = Object.freeze({
